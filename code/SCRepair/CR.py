            ...
            for gen in count(start=0, step=1):
                ...
                if plausiblePatches:
                    ...
                    for idx, p in enumerate(plausiblePatches):
                        ...
                        args_execTC = ''
                        if ignoreVar:
                            args_execTC = F'/app/definery-see -symexe-eqcheck {newPath} {contractName} {ignoreVarName}'
                            referencePath = F'/contracts/{contractName}.sol'
                            args_execSummary= F'/app/definery-see -symexe-main {referencePath} {contractName} {ignoreVarName}'
                            ...
                            args_execTC = F'/app/definery-see -symexe-eqcheck {newPath} {contractName}'
